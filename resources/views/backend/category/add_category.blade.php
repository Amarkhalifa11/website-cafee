...
@section('content')
    <h1 class="text-center mt-3 mb-2">Add categories</h1>
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        <form action="{{ route('category.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="category" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
